...
const EditTitle = () => {
    ...
    return <span>Foydalanuvchini tahrirlash {record ? `"${record.firstName || record.email || record.id}"` : ''}</span>;
};
    ...
    <Edit title={<EditTitle />} redirect="show">
        <SimpleForm sx={{
            ...
            <Box mb={2}>
                ...
                <TextInput source="telegramUsername" label="Telegram" fullWidth />
            </Box>

            <Box mb={2} mt={2}>
                <Typography variant="h5" sx={{ color: '#114539', fontWeight: 700 }} gutterBottom>Tizim sozlamalari</Typography>
                <Divider sx={{ mb: 3 }} />
                <Box display="flex" gap={2} width="100%">
                ...
                <DateInput source="createdAt" label="Ro'yxatdan o'tgan" disabled fullWidth />
            </Box>
