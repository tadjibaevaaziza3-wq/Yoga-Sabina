...
export default function ConsultationDetailPage({ params }: PageProps) {
    ...
    if (loading) {
        return <div className="min-h-screen bg-gradient-to-br from-[var(--primary)] to-[var(--primary)] flex items-center justify-center">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[var(--primary)] to-[var(--primary)] py-12 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="bg-white/5 rounded-2xl p-6 mb-8">
                        <div className="text-[var(--secondary)] whitespace-pre-line leading-relaxed">
                    ...
                    <button
                        ...
                        className="w-full bg-gradient-to-r from-[var(--accent)] to-[var(--accent)] hover:from-[var(--accent)] hover:to-[var(--primary)] text-white font-bold py-4 px-8 rounded-xl text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                    >
