...
export default async function OnlineCoursesPage({
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <section className="pt-32 pb-20 bg-emerald-50">
                <Container>
                    <h1 className="text-5xl md:text-6xl font-serif font-black text-emerald-900 mb-6">
                        Online Kurslar
                    </h1>
                    <p className="text-xl text-emerald-900/60 max-w-2xl leading-relaxed">
                        Dunyoning istalgan nuqtasidan turib meditatsiya va yoga bilan shug'ullaning.
                        Premium sifatdagi online dasturlarimiz bilan ichki xotirjamlikka erishing.
                    </p>
                </Container>
            </section>
                            ...
                            <div key={course.id} className="group bg-white border border-emerald-100 rounded-[2.5rem] overflow-hidden hover:shadow-2xl hover:shadow-emerald-900/10 transition-all duration-500">
                                <div className="aspect-[4/3] relative overflow-hidden">
                                    ...
                                    <div className="absolute top-6 left-6">
                                        <span className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest text-emerald-900">
                                            Online
                                        </span>
                                    </div>
                                </div>
